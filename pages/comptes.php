...
<div class="container">
    <div class="row">
        ...
        <div class="col-12 cell">
            ...
            <h2>Vous pourrez gr&acirc;ce &agrave; cette interface voir les d&eacute;tails de vos comptes et faire
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 centrerVerticalement">
                    <div class="row">
                        ...
                        <div class="col-12 centrerHorizontalement"> <!-- Bouton -->
                            <div class="btn btn-primary boutonTexte">D&eacute;tail du compte <i class="fa-solid fa-list"></i></div>
                        </div>
                    </div>
                </div>
                <!-- Solde -->
                <div class="col-md-3 col-sm-12 centrerVerticalement centrerHorizontalement">
                    <p class="solde negatif">-50,00&euro;</p>
                </div>
            </div>
        </div>
